									...
									<div class="row">
										...
										<div class="col-sm-8 form-group">
											...
											<table>
												...
												<tr>
													<td>Tossa (New)</td>
													<td><input type="text" name="tgr1"
														class="form-control"></td>
													<td><input type="text" name="tgr2"
														class="form-control"></td>
													<td><input type="text" name="tgr3"
														class="form-control"></td>
													<td><input type="text" name="tgr4"
														class="form-control"></td>
													<td><input type="text" name="tgr5"
														class="form-control"></td>
												</tr>
												<tr>
													<td>White (New)</td>
													<td><input type="text" name="wgr1"
														class="form-control"></td>
													<td><input type="text" name="wgr2"
														class="form-control"></td>
													<td><input type="text" name="wgr3"
														class="form-control"></td>
													<td><input type="text" name="wgr4"
														class="form-control"></td>
													<td><input type="text" name="wgr5"
														class="form-control"></td>
												</tr>
												<tr>
													<td>Mesta</td>
													<td><input type="text" name="mgr1"
														class="form-control">
													<td><input type="text" name="mgr2"
														class="form-control"></td>
													<td><input type="text" name="mgr3"
														class="form-control"></td>
													<td><input type="text" name="mgr4"
														class="form-control"></td>
													<td><input type="text" name="mgr5"
														class="form-control"></td>
													<td><input type="text" name="mgr6"
														class="form-control"></td>
												</tr>
												<tr>
													<td>Bimli</td>
													<td><input type="text" name="bgr1"
														class="form-control"></td>
													<td><input type="text" name="bgr2"
														class="form-control"></td>
													<td><input type="text" name="bgr3"
														class="form-control"></td>
													<td><input type="text" name="bgr4"
														class="form-control"></td>
													<td><input type="text" name="bgr5"
														class="form-control"></td>
													<td><input type="text" name="bgr6"
														class="form-control"></td>
												</tr>
											</table>
