...
<body class="fixed-navbar">
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<%
			List<UserRegistrationModel> allUserRegistration = (List<UserRegistrationModel>) request
					.getAttribute("UserRegistrationList");
			%>
							...
							<table
								...
								<tbody>
									...
									<tr>
										...
										<td><a
											href="updateuserProfile.obj?id=<%=UserRegistrationList.getRefid()%>"><button
													class="btn btn-default" type="button">Edit</button></a></td>
										<td><a
											href="bnaDelete.obj?id=<%=UserRegistrationList.getRefid()%>"
											class="btn btn-danger btn-sm btn-block"
											onclick="return confirm('Are you sure you want to delete this BNA')">Delete</a></td>
